...
function preview() {
    ...
    document.getElementById("greetMsg").style.fontFamily = fontFam;
...
function markAsFav() {
    ...
    newItem = { "select": eventName, "recipientName": recName, "eventDate": eventDate, "customMessage": customMsg, "bgColor": bgCol, "greetTxtColor": greetTxtCol };
