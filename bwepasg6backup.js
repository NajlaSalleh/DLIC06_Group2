function markFav() {
    ...
    if (localStorage.getItem("favouritedCards") != null) {
     ...
     newBlock = { "eventGreeting": eventName, "recipientName":
...
function applyData(cardObj) {
    ...
    document.getElementById("inputFontCol").value = cardObj.fontColor;
    document.getElementById("inputBordCol").value = cardObj.borderColor;
}
